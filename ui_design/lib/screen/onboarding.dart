...
import 'package:ui_design/screen/onboarding2.dart';
           ...
           Column(
            ...
            children: [
               Padding(
                 ...
                 child: Text("Update Progress Your\nWork for The Team",style: myStyle(36,Color(0xffE4E4E6),FontWeight.w700),),
               ),

               SizedBox(height: 32),
               Padding(
                 padding: const EdgeInsets.only(left: 16),
                 child: SvgPicture.asset("asset/s1.svg"),
               ),
              SizedBox(height: 36),
              CustomButton(
