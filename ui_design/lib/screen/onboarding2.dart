...
import 'package:ui_design/screen/onboarding3.dart';
           ...
           Column(
            ...
            children: [
               Padding(
                 ...
                 child: Text("Create a Task and\nAssign it to Your\nTeam Members",style: myStyle(36,Color(0xffE4E4E6),FontWeight.w700),),
               ),

               SizedBox(height: 32),
               Padding(
                 padding: const EdgeInsets.only(left: 16),
                 child: SvgPicture.asset("asset/s2.svg"),
               ),
              SizedBox(height: 36),
              CustomButton(
